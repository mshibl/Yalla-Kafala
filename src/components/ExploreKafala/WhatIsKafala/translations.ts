export const translations = {
  ...
  firstHadith: {
    ...
    essentialPhrases: {
      title: {
        en: "Some of the essential phrases contained in this hadith are:",
        ar: "من أهم ما ورد في الحديث:",
      },
      phrases: {
        en: [
  ...
  Footnote: {
    copiedFrom: {
      en: "[Copied from as-Sunnah magazine (published in Indonesia), 11th Edition / Year XV / Rabiul Akhir 1433 AH / 2012. Publisher: Lajnah Istiqomah Foundation Surakarta, Solo-Purwodadi Street km. 8, Selokaton, Gondangrejo, Solo - 57183.]",
      ar: "",
    },
    list: {
      listTitle: {
      ...
      listItems: {
        en: [
          "[1]. See the book Aunul Mabuud (14/41) and Tuhfatul Ahwadzi (6/39)",
          "[2]. See the book Sharhu Sahiihi Muslim (18/113)",
          "[3]. See the book an-Nihaayah fi Ghariibil Hadiithi wal Atsar (5/689)",
          "[4]. See the book Sharhu Shahiihi Muslim (18/113) and Faidhul Qadiir (3/49)",
          "[5]. Ibid",
          "[6]. As in hadith Sahiih narrated by al-Bukhari (3778), see also the book Tafsiir al-Qurtubi (14/119)",
          "[7]. Mahram is a person who is unlawful to be married forever with a muted cause (allowed in religion). See the book Fathul Baari (4/77)",
        ],
        ar: [
    ...
    list: {
      listItems: {
        en: [
          ...
          "Care of Abandoned Children in Sunni Islamic Law: Early Modern Egypt in Theory and Practice. Ahmed Fekry Ibrahim - Filiation and the Protection of Parentless Children. 03 Jul 2019",
          "us-Sunnah Foundation: https://www.ussunnah.org/2018/11/28/the-virtue-of-taking-care-of-the-orphans",
        ],
        ar: [
          "https://bettercarenetwork.org/library/the-continuum-of-care/adoption-and-kafala",
          "Care of Abandoned Children in Sunni Islamic Law: Early Modern Egypt in Theory and Practice. Ahmed Fekry Ibrahim - Filiation and the Protection of Parentless Children. 03 Jul 2019",
